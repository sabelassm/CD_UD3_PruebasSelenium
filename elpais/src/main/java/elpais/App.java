...
public class App {
    ...
    /**
     * @param pagina web de <a href="www.elpais.com">elpais</a>
     * @throws Exception
     * @author Alberto Durán
     */
    public static void main(String[] args) throws Exception {

        System.setProperty("webdriver.chrome.driver", "./elpais/driver/chromedriver");
        ...
        /**
         * HACER CLICKS EN LA SECCIÓN DE METEREOLOGÍA A VECES FALLA DEPENDIENDO DE LA
         * VELOCIDAD CON LA QUE SE CARGUE LA PÁGINA(solo se prueba con dos clicks)
         */
        ...
        /**
         * <b>Introducir caracteres no latinos en el apartado "suscribirse"</b>
         * 
         */
        ...
        /**
         * probar si existe la política de protección de datos
         */
        ...
        /**
         * introducir números en el buscador de noticias
         */
