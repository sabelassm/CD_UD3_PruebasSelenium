...
public class testApp {
	...
	public void enlacesMenu() throws InterruptedException {
		 ...
		 */
		String[] url = { "https://www.rakayoclothing.com/", "https://www.rakayoclothing.com/collections/all",
		...
		for (int i = 0; i < 3; i++) { /** Comprueba para cada una de las páginas los enlaces con el resto */
			...
			driver.get(url[i]);
			driver.findElement(By.xpath("//ul[@id='SiteNav']//li//a[contains(text(), 'Catálogo')]")).click(); /** Pulsar botón Catálogo */
	...
	public void comprarItem() throws InterruptedException {
		...
		driver.findElement(By.className("product-card")).click(); /** Seleccionar el primer producto de la lista */
		Thread.sleep(1500);
	...
	public void comprarAlternativa() throws InterruptedException {
		driver.get("https://www.rakayoclothing.com/");  /** Cargar página de inicio */
		driver.findElement(By.xpath("//ul[@id='SiteNav']//li//a[contains(text(), 'Catálogo')]")).click(); /** Abrir el catálogo */
		driver.findElement(By.className("product-card")).click(); //** Selecciona el primer producto */
		Thread.sleep(1500);
		...
		js.executeScript("window.scrollBy(0,350)", "");
		Thread.sleep(1000);
		driver.findElement(By.xpath("//button[@class='btn'][@name='checkout']")).click(); /** Pulsar comprar */
		Thread.sleep(1500);
	...
	public void comprarUnidadInvalida() throws InterruptedException {
		...
		for (int i = 0; i < unitValue.length; i++) { 
			driver.get("https://www.rakayoclothing.com/"); /** Cargar página de inicio */
			driver.findElement(By.xpath("//ul[@id='SiteNav']//li//a[contains(text(), 'Catálogo')]")).click(); /** Abrir catálogo */
			driver.findElement(By.className("product-card")).click(); /** Seleccionar el primer producto */
			Thread.sleep(1500);
			...
			List<WebElement> elems = driver.findElements(By.xpath("//button[@class='btn'][@name='checkout']")); /** Buscar botón de compra */
